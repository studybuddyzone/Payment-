...
// Ye ab try/catch ke andar hai taaki agar env var missing/galat ho to
// crash hone ke bajaye saaf JSON error mile (Vercel ka generic "A server
// error has occurred" HTML page nahi aayega).
// ---------------------------------------------------------------
let initError = null;
try {
...
const adminAuth = initError ? null : admin.auth();
